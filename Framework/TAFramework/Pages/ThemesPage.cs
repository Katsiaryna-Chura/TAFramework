...
namespace TAFramework.Pages
{
    public class ThemesPage : BasePage
    {
        ...
        public Button BtnSelectPhotoFromComputer { get; private set; } = new Button(By.XPath("//div[text()='Select a photo from your computer']"));
        public Label LblUploadError { get; private set; } = new Label(By.XPath("//span[contains(text(),'There was an upload error')]"));
