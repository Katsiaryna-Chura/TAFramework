...
namespace TAFramework.Pages
{
    ...
    {
        public Label LblSpamMessageSubject { get; private set; } = new Label();
        public Checkbox CbMessageChecker { get; private set; } = new Checkbox();

        public Button BtnNotSpam { get; private set; } = new Button(By.XPath("//div[@role='button' and text()='Not spam']"));

        public Button BtnCleanSpam { get; private set; } = new Button(By.XPath("//span[contains(.,'Delete all spam messages now')]"));
