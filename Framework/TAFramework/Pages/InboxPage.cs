...
namespace TAFramework.Pages
{
    class InboxPage : BasePage
    {
        ...
        public Button BtnReportSpam { get; private set; } = new Button(By.XPath
            ("//div[@class = 'asl T-I-J3 J-J5-Ji']"));//div[@data-tooltip='Report spam')] doesn't work
        public Button BtnDelete { get; private set; } = new Button(By.XPath
            ("//div[@class='ar9 T-I-J3 J-J5-Ji']"));//div[@aria-label='Delete'] doesn't work

        public Link LinkToMessage { get; private set; } = new Link();
        public BaseElement Message { get; private set; } = new BaseElement();
        public Button BtnRefresh { get; private set; } = new Button(By.XPath
            ("//div[@class='asf T-I-J3 J-J5-Ji']"));//div[@aria-label='Refresh'] doesn't work
